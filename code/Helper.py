...
#from FileMetaData import FileMetaOptions
import math
import json
import time
import bitcoinlib
...
class Helper:
    ...
    def GetEndIndex(uploadSize, fileMetaOptions):
        ...
        chunckSize = blockSize + Constants.BLOCK_OVERHEAD
        chunckCount = int(uploadSize / chunckSize) + 1
        chunksPerPart = int(partSize / chunckSize) + 1

        endIndex = int(chunckCount / chunksPerPart) + 1
